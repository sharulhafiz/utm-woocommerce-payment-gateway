...
/**
 * Settings for UTM FPX Gateway.
 */
return array(
	'enabled' => array(
		'title'   => __( 'Enable/Disable', 'woocommerce' ),
		'type'    => 'checkbox',
		'label'   => __( 'Enable UTM FPX', 'woocommerce' ),
		'default' => 'no',
	),
	'title' => array(
		...
		'default'     => __( 'UTM FPX', 'woocommerce' ),
		'desc_tip'    => true,
	),
	'description' => array(
		...
		'default'     => __( "Pay via UTM FPX; you can pay with your credit card or bank account.", 'woocommerce' ),
	),
	'email' => array(
